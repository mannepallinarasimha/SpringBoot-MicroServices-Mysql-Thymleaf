...
public class BillServiceImpl implements BillService {
    ...
    private void insertBill(Map<String, Object> requestMap) {
        ...
        try {
            ...
            log.info("**********Bill save() before ::::", bill);
            billDao.save(bill);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public ResponseEntity<List<Bill>> getBills() {
            ...
            if(jwtFilter.isAdmin()){
                //return all the bills in desc order
                list = billDao.getAllBills();
            }else{
                //return  the bills on current basis
    ...
    public ResponseEntity<String> deleteBill(Integer id) {
        try {
            ...
            if(!optional.isEmpty()){
                ...
                return CafeUtils.getResponseEntity("Bill with ID Doesn't Exist", HttpStatus.OK);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
